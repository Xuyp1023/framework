...
public class MapperAnnotationBuilder {
                ...
                try {
                    if (!method.isBridge()) { // issue #237
                        ...
                        if (suMethod == null) {
                            ...
                            // System.out.println("XXXX"+ suMethod.getDeclaringClass().getName() +"."+
                            // suMethod.getName() );
                        }
    ...
    void parseStatement(Method method, Method anSuperMethod) {
        ...
        if (sqlSource == null) {
            // System.out.println("is null " + method.getName() +", anSuperMethod = "+
            // anSuperMethod.getDeclaringClass().getName());
