...
public class SqlSessionFactoryBean
    ...
    * be provided to application code accessing this {@code DataSource} directly
    * via {@code DataSourceUtils} or {@code DataSourceTransactionManager}.
    * 
    ...
    * {@code XMLConfigBuilder} API to build a {@code SqlSessionFactory} instance
    * based on an Reader.
    * 
