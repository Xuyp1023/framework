...
public class RedisCache implements Cache {
    ...
    private String getKeyName(Object key) {
        ...
        if (key instanceof Number) return region + ":I:" + key;
        else {
    ...
    public Object get(Object key) throws CacheException {
        ...
        try {
            ...
            if (b != null) obj = SerializationUtils.deserialize(b);
        }
        catch (Exception e) {
            log.error("Error occured when get data from L2 cache", e);
            broken = true;
            if (e instanceof IOException || e instanceof NullPointerException) evict(key);
        }
        finally {
