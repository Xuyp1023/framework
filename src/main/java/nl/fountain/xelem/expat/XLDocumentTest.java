...
public class XLDocumentTest extends TestCase {
    ...
    @Override
    public void setUp() {
        templateFile = "testsuitefiles/XLDocumentTest/aviso.xml";
    }
    ...
    public void testConstructor() {
        try {
            ...
            assertEquals("java.io.FileNotFoundException", e.getCause().getClass().getName());
        }
        try {
    ...
    public void testGetTable() throws Exception {
        ...
        assertNotNull(table);
        try {
            table.getAttributes().removeNamedItemNS(XLElement.XMLNS_SS, "ExpandedColumnCount");
        ...
        try {
            table.getAttributes().removeNamedItemNS(XLElement.XMLNS_SS, "ExpandedRowCount");
            fail("should have thrown exception.");
        }
        catch (DOMException e) {
            //
        ...
        try {
            ...
            assertEquals("The worksheet 'nosheetwiththisname' does not exist.", e1.getMessage());
        }
    }
    ...
    public void testPivot() {
        Object[][] data = { { "blue", "A", "Star", new Double(2.95), new Double(55.6) },
        ...
        try {
            ...
            xlDoc.setPTSourceReference(1, 1, rows.size() + 1, 5);
            // output the new file
            out = new BufferedOutputStream(new FileOutputStream(testOutputDir + fileName));
