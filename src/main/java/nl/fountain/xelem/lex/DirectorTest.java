...
public class DirectorTest extends TestCase {
    ...
    public void testGetAnonymousBuilder() throws Exception {
        AnonymousBuilder builder1 = director.getAnonymousBuilder();
        assertTrue(builder1.isOccupied());
        AnonymousBuilder builder2 = director.getAnonymousBuilder();
        ...
        assertTrue(!builder2.isOccupied());
        AnonymousBuilder builder3 = director.getAnonymousBuilder();
