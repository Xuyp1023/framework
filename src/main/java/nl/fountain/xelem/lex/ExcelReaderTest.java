...
public class ExcelReaderTest extends TestCase {
    ...
    public void testConstructorWithGivenParser() throws Exception {
        ...
        try {
            ...
            assertEquals("cannot read with a parser that is unaware of namespaces.", e.getMessage());
        }
    }
    ...
    public void testDocumentProperties() throws Exception {
        ...
        char cr = 13;
        char lf = 10;
        assertEquals("testing � � � � � documentproperties" + cr + lf + "more comments" + cr + lf + "and more...",
    ...
    public void testGetWorksheetAt() throws Exception {
        String[] sheetNames = { "Tom Poes", "Donald Duck", "Asterix", "Sponge Bob", "window" };
        Workbook wb = getReaderWorkbook();
        Worksheet sheet;
        int i = 0;
