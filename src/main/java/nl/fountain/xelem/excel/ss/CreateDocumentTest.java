...
public class CreateDocumentTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        String configFileName = "testsuitefiles/CreateDocumentTest/CreateDocumentTest.xml";
    ...
    public void testAdvise() {
        if (toFile) {
            System.out.println();
            System.out.println(this.getClass() + " is writing files to: " + testOutputDir);
        }
    }
    ...
    public void testConfigurationFile2() throws Exception {
        ...
        assertTrue(
                w2.indexOf("WARNING 2): nl.fountain.xelem." + "UnsupportedStyleException: Style 'bar' not found.") > 0);
    ...
    public void testWorkbook() throws Exception {
        ...
        String xml = xmlToString(wb);
        // System.out.println(xml);
        assertTrue(xml.indexOf("<Workbook xmlns=\"urn:schemas-microsoft-com:office:spreadsheet\" ") > 0);
        assertTrue(xml.indexOf("xmlns:o=\"urn:schemas-microsoft-com:office:office\"") > 0);
        assertTrue(xml.indexOf("xmlns:x=\"urn:schemas-microsoft-com:office:excel\"") > 0);
        assertTrue(xml.indexOf("xmlns:ss=\"urn:schemas-microsoft-com:office:spreadsheet\"") > 0);
        assertTrue(xml.indexOf("xmlns:html=\"http://www.w3.org/TR/REC-html40\"") > 0);
    ...
    public void testMultipleWorksheets() throws Exception {
        ...
        String xml = xmlToString(wb);
        assertTrue(xml.indexOf("<ss:Worksheet ss:Name=\"Sheet1\"/>") > 0);
        assertTrue(xml.indexOf("<ss:Worksheet ss:Name=\"foo\" " + "ss:RightToLeft=\"1\"/>") > 0);
    ...
    public void testTableAttributes() throws Exception {
        ...
        String warningString = wb.getWarnings().get(0);
        assertTrue(warningString.indexOf(
                "WARNING 1): nl.fountain.xelem.UnsupportedStyleException: " + "Style 'no_definition' not found.") > 0);
    ...
    public void testCellAttributes() throws Exception {
        ...
        String xml = xmlToString(wb);
        assertTrue(xml.indexOf("<ss:Cell " + "ss:HRef=\"http://www.microsoft.com/downloads/details.aspx"
    ...
    public void testData() throws Exception {
        ...
        sheet.addCellAt(19, 3)
                .setData(new BigDecimal("1234567890123456789012345678901234567890"
    ...
    public void testWorksheetOptions() throws Exception {
        ...
        wb.addSheet("not visible").getWorksheetOptions().setVisible(WorksheetOptions.SHEET_HIDDEN);
    ...
    public void testNamedRanges() throws Exception {
        ...
        String xml = xmlToString(wb);
        assertTrue(xml.indexOf("<ss:NamedRange ss:Name=\"foo\" " + "ss:RefersTo=\"blad!R1C3:R10C3\"/>") > 0);
    ...
    public void testSpecialCharacters() throws Exception {
        ...
        wb.addSheet().addCell("2020 BV Financi雗");

        String xml = xmlToString(wb);
        assertTrue(xml.indexOf("<Data ss:Type=\"String\">2020 BV Financi雗</Data>") > 0);
    ...
    public void test29() throws Exception {
        ...
        wb.addSheet();
        Worksheet sheet = wb.addSheet();
        sheet.addCell("this sheet is selected; " + "the workbooks structure is protected. (cannot move sheets)");
    ...
    private void xmlToFile(Workbook wb) throws Exception {
        Result result = new StreamResult(new File(testOutputDir + wb.getFileName()));
        transform(wb, result);
    }
