...
public class CSVWriter implements Closeable, Flushable {
    ...
    */
    public int writeAll(java.sql.ResultSet rs, boolean includeColumnNames, boolean trim)
    ...
    */
    public void writeNext(String[] nextLine, boolean applyQuotesToAll) {
        ...
        StringBuilder sb = new StringBuilder(nextLine.length * 2); // This is for the worse case where all elements have
                                                                   // to be escaped.
    ...
    */
    protected StringBuilder processLine(String nextElement) {
        StringBuilder sb = new StringBuilder(nextElement.length() * 2); // this is for the worse case where all elements
                                                                        // have to be escaped.
