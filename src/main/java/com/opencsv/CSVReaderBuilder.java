...
public class CSVReaderBuilder {
    ...
    public static CSVReaderBuilder create(final Reader anReader) {

        return new CSVReaderBuilder(anReader);
    }
     ...
     *
     * @param verifyReader
     *            true if CSVReader should verify reader before each read, false otherwise.
     ...
     *
     * @param indicator
     *            - CSVReaderNullFieldIndicator set to what should be considered a null field.
     * @return The CSVReaderBuilder based on this criteria.
     */
