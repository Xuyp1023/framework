...
public class InstructionSetRunner {
    ...
    public static Object executeOuter(ExpressRunner runner, InstructionSet[] sets, ExpressLoader loader,
        ...
        try {
            ...
            return execute(runner, sets, loader, aContext, errorList, isTrace, isCatchException, true, aLog,
    ...
    public static Object execute(ExpressRunner runner, InstructionSet[] sets, ExpressLoader loader,
        ...
        InstructionSetContext context = OperateDataCacheManager.fetchInstructionSetContext(true, runner, aContext,
                loader, isSupportDynamicFieldName);
        Object result = execute(sets, context, errorList, isTrace, isCatchException, isReturnLastData, aLog);
        return result;
    }

    public static Object execute(InstructionSet[] sets, InstructionSetContext context, List<String> errorList,
        ...
        for (int i = 0; i < sets.length; i++) {
            ...
            environmen = OperateDataCacheManager.fetRunEnvironment(tmpSet, context, isTrace);
            try {
                CallResult tempResult = tmpSet.excute(environmen, context, errorList, i == sets.length - 1,
