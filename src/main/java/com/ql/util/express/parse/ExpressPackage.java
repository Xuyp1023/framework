...
public class ExpressPackage {
    ...
    private Map<String, String> name2FullMap = new ConcurrentHashMap<String, String>();
    ...
    public void addPackage(String aPackageName) {
        ...
        addPackageClasses(aPackageName);
    }

    private void addPackageClasses(String anPackageName) {
        Package pp = Package.getPackage(anPackageName);
        if (pp != null) {
            Class cc;
            int pos = 0;
    ...
    public Class<?> getClass(String name) {
        ...
        if (tempClass == null) {
            ...
            if (tempClass == null) {
                ...
                if (tempClass == null) {
                    String tmpC = name2FullMap.get(name);
                    if (tmpC != null) {
                        try {
