...
public class InstructionCallSelfDefineFunction extends Instruction {
    ...
    public static OperateData executeSelfFunction(RunEnvironment environment, InstructionSet functionSet,
        ...
        InstructionSetContext context = OperateDataCacheManager.fetchInstructionSetContext(true,
                environment.getContext().getExpressRunner(), environment.getContext(),
        ...
        Object result = InstructionSetRunner.execute(new InstructionSet[] { functionSet }, context,
                errorList, environment.isTrace(), false, true, log);
