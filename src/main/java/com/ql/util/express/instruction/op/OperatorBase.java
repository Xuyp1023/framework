...
public abstract class OperatorBase implements java.io.Serializable {
    ...
    private static final long serialVersionUID = 8462680454300075269L;
    ...
    public Object[] toObjectList(InstructionSetContext parent, OperateData[] list) throws Exception {
        if (list == null) {
            return new Object[0];
        }
    ...
    public OperateData execute(InstructionSetContext context, OperateData[] list, List<String> errorList)
            throws Exception {
        ...
        if (errorList != null && this.errorInfo != null && result != null) {
            ...
            if (obj != null && obj instanceof Boolean && ((Boolean) obj).booleanValue() == false) {
