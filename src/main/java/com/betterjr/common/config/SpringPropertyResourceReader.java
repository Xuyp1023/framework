    ...
    static{
        try{
            ...
            for (final String ppName : postProcessorNames) {
                ...
                final BeanFactoryPostProcessor beanProcessor=
                        SpringContextHolder.getApplicationContext().getBean(ppName, BeanFactoryPostProcessor.class);
                ...
                if(beanProcessor instanceof PropertySourcesPlaceholderConfigurer){
                    final PropertyResourceConfigurer propertyResourceConfigurer=
                            (PropertyResourceConfigurer) beanProcessor;

                    // get the method mergeProperties
                    // in class PropertiesLoaderSupport
                    final Method mergeProperties=PropertiesLoaderSupport.class.
                            getDeclaredMethod("mergeProperties");
                    // get the props
                    mergeProperties.setAccessible(true);
                    final Properties props=(Properties) mergeProperties.
