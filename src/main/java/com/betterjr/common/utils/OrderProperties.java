         ...
         if (aChar == '\\') {
            ...
            if (aChar == 'u') {
               ...
               if (aChar == 't') outBuffer.append('\t'); /* ibm@7211 */
                  ...
                  /*
                   * ibm@8897 do not convert a \n to a line.separator because on
                   * some platforms line.separator is a String of "\r\n". When a
                   * Properties class is saved as a file (store()) and then
                   * restored (load()) the restored input MUST be the same as
                   * the output (so that Properties.equals() works).
                   *
                   */
                  outBuffer.append('\n'); /* ibm@8897 ibm@7211 */
               }
