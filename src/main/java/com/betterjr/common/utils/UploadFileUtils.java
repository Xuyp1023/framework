...
public class UploadFileUtils {
    ...
    public static String sanitizeFolderName(final String folderName) {
        ...
        if (StringUtils.isBlank(folderName)) return folderName;
    ...
    public static boolean isValidPath(final String path) {
        ...
        if (ILLEGAL_CURRENT_FOLDER_PATTERN.matcher(path).find()) return false;
    ...
    public String[] uploadFile(HttpServletRequest request) {
        ...
        // 上传
        List<FileItem> fiList = (List<FileItem>) fieldsMap.get(UploadFileUtils.FILE_FIELDS);
        if (fiList != null) {
