...
public class BetterX509KeyManager extends X509ExtendedKeyManager {

    private final X509ExtendedKeyManager keyManager;
    private final PrivateKeyStrategy aliasStrategy;

   public BetterX509KeyManager(final X509ExtendedKeyManager keyManager, final PrivateKeyStrategy aliasStrategy) {
        super();
