...
// ============================================================================
package com.betterjr.modules.config.dubbo;
 ...
 *
 */
@Service(interfaceClass = IDomainAttributeService.class)
public class DomainAttributeDubboService implements IDomainAttributeService {
    @Resource
